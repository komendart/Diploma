...
%	\includepdf[pages=-]{titlesheet.pdf}
    ...
    \addcontentsline{toc}{section}{Обзор смежной задачи}
    \input{related_overview.tex}
    \newpage
    
    \section*{Точное решение за $O(n^3+S)$ времени}
    \addcontentsline{toc}{section}{Точное решение за $O(n^3+S)$ времени}
    \input{exact_solution.tex}
    \newpage
    
    \section*{Асимптотически оптимальное приближенное решение}
    \addcontentsline{toc}{section}{Асимптотически оптимальное приближенное решение}
    \input{approximate_solution.tex}  %% TODO !!!
    \newpage
